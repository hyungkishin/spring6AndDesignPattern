package hyungkispring.hellospring.api;
...
public class ApiTemplate {
    ...
    private final ErApiExRateExtractor exRateExtractor;
    ...
    public ApiTemplate(ApiExecutor apiExecutor, ErApiExRateExtractor exRateExtractor) {
